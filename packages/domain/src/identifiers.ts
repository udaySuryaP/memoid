...
export type SourceAuthorityScopeId = OpaqueId<"SourceAuthorityScopeId">;
export type SourceAuthorityAssignmentId = OpaqueId<"SourceAuthorityAssignmentId">;
...
export type ReconciliationId = OpaqueId<"ReconciliationId">;
...
export type ConflictId = OpaqueId<"ConflictId">;
export type ConflictOccurrenceId = OpaqueId<"ConflictOccurrenceId">;
export type UncertaintyId = OpaqueId<"UncertaintyId">;
export type UncertaintyOccurrenceId = OpaqueId<"UncertaintyOccurrenceId">;
